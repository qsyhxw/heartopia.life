...
|---|---:|---|---|---|---|
| CODES-20260921 | NOW | UPDATE | `/codes/` plus localized code pages | Replaced 50 auto-promoted historical codes with 7 September weekly codes; all show matching rewards and Sep 30 deadline. Unknown crawler finds now remain pending; scheduled auto-publish was removed. | PASS — title/H1/canonical retained except factual date; answer table, expiry, redemption steps, verification notes, source links, image, mobile table scroll, footer links checked. |
| EVENTS-20260921 | NOW | UPDATE | `/events/` | Added Party Festival and Burger Bliss as active; added Sep 23 update as preview; no thin event detail URLs created. | PASS — confirmed schedules/tasks in active cards, preview uncertainty explicit, official external links marked, desktop/mobile/footer checked. |
