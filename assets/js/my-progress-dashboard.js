(function () {
    ...
    const progressItems = [
        { id: 'fish', title: 'Fish collected', icon: '&#128031;', image: '/img/fish/Anglerfish.webp', storageKey: 'heartopia.collection.fish', total: 124, url: '/database/fish/', action: 'Open fish database', color: 'sky' },
        { id: 'insects', title: 'Insects collected', icon: '&#129419;', image: '/img/insects/Abeja-Azul.webp', storageKey: 'heartopia.collection.insects', total: 101, url: '/database/insects/', action: 'Open insect database', color: 'sage' },
        { id: 'birds', title: 'Birds photographed', icon: '&#128038;', image: '/img/birds/African-Olive-Pigeon.webp', storageKey: 'heartopia.collection.birds', total: 103, url: '/database/birds/', action: 'Open bird database', color: 'coral' },
        ...
        { id: 'recipes', title: 'Recipes learned', icon: '&#127859;', image: '/img/recipes/Afternoon-Tea.webp', storageKey: 'heartopia.database.recipes.learned.v2', total: 173, url: '/database/recipes/', action: 'Open recipe database', color: 'recipe' },
