...
function siteHeader() { return `<header class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-cozy-peach/50"><nav class="max-w-6xl mx-auto px-4 py-3"><div class="flex items-center justify-between gap-4"><a href="/" class="flex shrink-0 items-center gap-2"><img src="/favicon-96x96.png" alt="Heartopia.Life" class="w-7 h-7"><span class="font-display text-xl font-bold">Heartopia<span class="text-cozy-sage">.Life</span></span></a><ul class="hidden md:flex items-center gap-5 text-sm font-medium"><li><a href="/guides/map/" class="hover:text-cozy-coral">Map</a></li><li><a href="/codes/" class="hover:text-cozy-coral">Codes</a></li><li><a href="/guides/" class="hover:text-cozy-coral">Guides</a></li><li><a href="/hobbies/" class="hover:text-cozy-coral">Hobbies</a></li><li><a href="/events/" class="hover:text-cozy-coral">Events</a></li><li><a href="/database/" class="font-bold text-cozy-coral">Database</a></li><li><a href="/npcs/" class="hover:text-cozy-coral">NPCs</a></li></ul><a href="/tools/daily-tasks/" class="md:hidden rounded-lg bg-cozy-peach px-3 py-2 text-xs font-bold">Tasks</a></div></nav></header>`; }
function siteFooter() { return `<footer class="bg-cozy-bark text-white py-8 mt-12"><div class="max-w-6xl mx-auto grid gap-8 px-4 text-sm md:grid-cols-3"><div><a href="/" class="inline-flex items-center gap-2"><img src="/favicon-96x96.png" alt="Heartopia.Life" class="w-7 h-7"><span class="font-display text-lg font-bold">Heartopia<span class="text-cozy-sage">.Life</span></span></a><p class="mt-3 leading-6 text-white/65">Unofficial fan guide. Check the game for current recipe availability and values.</p></div><div><h2 class="font-display text-base font-bold">Database</h2><div class="mt-3 grid gap-2 text-white/70"><a class="hover:text-cozy-sage" href="/database/recipes/">Recipes</a><a class="hover:text-cozy-sage" href="/database/ingredients/">Ingredients</a><a class="hover:text-cozy-sage" href="/database/crops/">Crops</a></div></div><div><h2 class="font-display text-base font-bold">Tools</h2><div class="mt-3 grid gap-2 text-white/70"><a class="hover:text-cozy-sage" href="/tools/recipe-calculator/">Recipe Calculator</a><a class="hover:text-cozy-sage" href="/tools/my-progress/">My Progress</a><a class="hover:text-cozy-sage" href="/tools/daily-tasks/">Daily Tasks</a></div></div></div><div class="max-w-6xl mx-auto mt-7 pt-5 px-4 border-t border-white/10 flex flex-wrap justify-between gap-3 text-xs text-white/45"><p>&copy; 2026 Heartopia.Life</p><p><a class="hover:text-white" href="/privacy/">Privacy Policy</a><span class="mx-2">&middot;</span><a class="hover:text-white" href="/contact/">Contact</a></p></div></footer>`; }

function pricePage(recipes, date) { const selected = [...recipes].filter(r => r.market.length).sort((a,b) => (b.market.at(-1) || 0) - (a.market.at(-1) || 0)).slice(0, 16); return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><script async src="https://www.googletagmanager.com/gtag/js?id=G-FRJ91G3VRR"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-FRJ91G3VRR')</script><script data-cfasync="false">window.nitroAds=window.nitroAds||{createAd:function(){return new Promise(e=>{window.nitroAds.queue.push(['createAd',arguments,e])})},queue:[]};</script><script data-cfasync="false" async src="https://s.nitropay.com/ads-2368.js"></script><script src="https://cdn.tailwindcss.com"></script><script>tailwind.config={theme:{extend:{colors:{cozy:{cream:'#FFF8F0',peach:'#FFE5D9',coral:'#FF9B85',sage:'#A8C686',mint:'#B8E0D2',wood:'#8B7355',bark:'#5D4E37'}},fontFamily:{display:['Georgia','serif'],body:['system-ui','sans-serif']}}}}</script><title>Heartopia Recipe Prices: Market Values by Tier</title><meta name="description" content="Compare verified Heartopia recipe market values, ingredients and energy tiers."><link rel="canonical" href="https://heartopia.life/database/recipe-prices/"></head><body class="bg-cozy-cream text-cozy-bark font-body">${siteHeader()}<main class="max-w-6xl mx-auto px-4 py-8"><a href="/database/recipes/" class="text-cozy-coral font-bold">Recipes</a><section class="bg-gradient-to-br from-amber-100 to-cozy-peach rounded-2xl p-7 mt-5 mb-8"><p class="text-sm font-bold text-cozy-sage">Updated: ${date}</p><h1 class="font-display text-3xl font-bold mt-2">Heartopia Recipe Price List</h1><p class="text-cozy-wood mt-3">Top listed Tier 4 market values. Use ingredient costs you actually paid before treating a high value as profit.</p></section><div id="heartopia_in_content" class="my-6"></div><div class="space-y-4">${foodCards(selected)}</div><div id="heartopia_in_content_2" class="my-6"></div></main>${siteFooter()}${adScript()}</body></html>`; }
function bestPage(recipes, date) { const selected = [...recipes].filter(r => r.market.length && r.availability !== 'Finished Event').sort((a,b) => (b.market.at(-1)||0)-(a.market.at(-1)||0)).slice(0, 12); return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><script async src="https://www.googletagmanager.com/gtag/js?id=G-FRJ91G3VRR"></script><script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-FRJ91G3VRR')</script><script data-cfasync="false">window.nitroAds=window.nitroAds||{createAd:function(){return new Promise(e=>{window.nitroAds.queue.push(['createAd',arguments,e])})},queue:[]};</script><script data-cfasync="false" async src="https://s.nitropay.com/ads-2368.js"></script><script src="https://cdn.tailwindcss.com"></script><script>tailwind.config={theme:{extend:{colors:{cozy:{cream:'#FFF8F0',peach:'#FFE5D9',coral:'#FF9B85',sage:'#A8C686',mint:'#B8E0D2',wood:'#8B7355',bark:'#5D4E37'}},fontFamily:{display:['Georgia','serif'],body:['system-ui','sans-serif']}}}}</script><title>Heartopia Best Food to Sell: Market Value Guide</title><meta name="description" content="Compare current Heartopia recipe market values, ingredients and energy without assuming a guaranteed profit."><link rel="canonical" href="https://heartopia.life/guides/best-food-to-sell/"></head><body class="bg-cozy-cream text-cozy-bark font-body">${siteHeader()}<main class="max-w-6xl mx-auto px-4 py-8"><a href="/database/recipes/" class="text-cozy-coral font-bold">Recipes</a><section class="bg-gradient-to-br from-cozy-peach to-cozy-mint rounded-2xl p-7 mt-5 mb-8"><p class="text-sm font-bold text-cozy-sage">Updated: ${date}</p><h1 class="font-display text-3xl font-bold mt-2">Heartopia Best Food to Sell</h1><p class="text-cozy-wood mt-3">Recipes with high listed market values, excluding entries currently marked as finished events. Ingredient availability and your own costs still matter.</p></section><div id="heartopia_in_content" class="my-6"></div><div class="space-y-4">${foodCards(selected)}</div><div id="heartopia_in_content_2" class="my-6"></div></main>${siteFooter()}${adScript()}</body></html>`; }
function calculatorPage(recipes, date) { const data = recipes.filter(r => r.market.length === 4 && r.ingredients.length).map(r => ({name:r.name,ingredients:r.ingredients,market:r.market})); let html = read('tools/recipe-calculator/index.html'); html = html.replace(/const recipes=\[.*?\];const search=/s, `const recipes=${JSON.stringify(data)};const search=`).replace(/(<strong id="calculable-count"[^>]*>)\d+/, `$1${data.length}`).replace(/Updated [A-Z][a-z]+ \d+, \d{4}/g, `Updated ${new Intl.DateTimeFormat('en-US',{month:'long',day:'numeric',year:'numeric',timeZone:'UTC'}).format(new Date(`${date}T00:00:00Z`))}`); return html; }
